...
That’s it. You don’t need to type anything in Terminal or install extra software.
...
QuickDSi is not affiliated with Nintendo or dsi.cfw.guide. Modding your DSi may void its warranty and has risks (for example bricking). You are responsible for backing up your data and following the guide. Use at your own risk. The app downloads files from their official sources; we do not modify them.
...
|-------|---------|-------------|
| BSV / MNEE | `1PJKRVMN2Rg3fGi8sQERgUmriBAZhUUQEa` | — |
| Bitcoin (BTC) | `1Ls2B31cSLKfSKQsSfCyhSsrXnQJkJgyUk` | — |
| Ethereum (ETH) | `0x9096313642C991483dA5802190fA7D1D5a324D31` | — |
| Solana (SOL) | `FVoiTWu3uoPRWxae5Bd1EroR9Vfgq7MAj4e5kcu7b2UZ` | — |
| Dogecoin (DOGE) | `DFJWJJqDrcZdBBsxVn67vnu8YoqQw8oQcL` | — |
| Litecoin (LTC) | `LNWgV8QuCkYW4tH8gxNHrZ2HXUUKnFQGAD` | — |
| Bitcoin Cash (BCH) | `qrmt44wh7v00hrdz2qzzxzdja3y2glaxvsu27vcl2e` | — |
| BCH (Tokens Only) | `zrmt44wh7v00hrdz2qzzxzdja3y2glaxvsmqdjke42` | — |

**Monero (XMR)** — use this address (long, so it’s on its own line):
...
For ETH and Solana, add memo **Quick DSi Modder - Donation** in your wallet if it supports a memo field.
...
- YourKalamity — Lazy DSi file downloader; QuickDSi is based on that project’s flow.
